...
if(isset($_POST['submit'])){
    ...
    $sql= "SELECT id,Username,Mail,Pass FROM Users WHERE Pass='$Pass' AND Mail='$Mail' Or Username='$Mail'";
    ...
    else      echo "<script>alert('Incorred Pass !!');</script>";
                    ...
                    <div class="form-container">
                        <form  method="POST" action="login.php">
                            <div class="form-group">
                                <input type="email" name="Mail" class="form-control-input" id="lemail" required>
                                <label class="label-control" for="lemail">Email</label>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                                <input type="text" name="Pass" class="form-control-input" id="lpassword" required>
